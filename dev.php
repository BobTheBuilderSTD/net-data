...
$converted_hash = number_format($terahash . 3); // display terahash with three decimal places and unit
...
if (isset($_POST['submit'])) {
	...
	$api_url = 'https://api.coingecko.com/api/v3/simple/price?ids=dingocoin&vs_currencies=usd';
	$parameters = array(
		'symbol' => 'DINGOCOIN',
		"convert" => $csym
	);
	...
	function convert_e5_to_decimal($response)
	{
		$pattern = '/(?<=:)-?\d+\.\d+(?=,|\})/'; // regex pattern to match e-5 notation numbers
		preg_match_all($pattern, $response, $matches);

		foreach ($matches[0] as $match) {
			$decimal = number_format((float) $match, 7, '.', '');
			$response = str_replace($match, $decimal, $response);
			$dprice = convert_e5_to_decimal($response);
		}
		return $response;
	}
...
<div class="container-xxl">
	<div class="container">
		<div class="mx-auto wow fadeInUp" data-wow-delay="0.4s">
							...
							<div class="card-body">
								<div class="container text-center justify-content-center align-items-center">
									<div class="row">
										<div class="col-md-2">
											<br>
											<h4 class="card-title">DINGOCOIN <br>Network</h4>
										</div>
										<div class="col-md-2">
											<br>
											<b><h6>Network (GH/s)</h6></b>
											<!-- DATA -->
											<h6 data-toggle="counter-up"><?php echo $dhash ?></h6>
											<!-- DATA -->
										</div>
										<div class="col-md-1">
											<br>
											<b><h6>Difficulty</h6><h6></h6></b>
											<!-- DATA -->
											<h6 data-toggle="counter-up"><?php echo $cdiff ?></h6>
											<!-- DATA -->
										</div>
										<div class="col-md-2">
											<br>
											<b><h6>Coin Supply</h6></b>
											<!-- DATA -->
											<h6 data-toggle="counter-up"> <?php echo $csupply ?> </h6>
											<!-- DATA -->
										</div>
										<div class="col-md-2">
											<br>
										...
										<div class="col-md-1">
											<br>
											<b><h6>Price <small></small></h6></b>
											<!-- DATA -->
											<small><h6 data-toggle="counter-up">
												<?php echo number_format($dprice, 8) ?>
											</h6></small>
											<b><h6> <small>[<?php echo $csym; ?>]</small></h6></b>
											<!-- DATA -->
										</div>
										<div class="col-md-2 text-center justify-content-center align-items-center">
											<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
												<div class="input-group">
													<p class="text-center"><small>Price is in USD by Default</small>
														<select class="form-select form-select-sm" name="currencies"
															aria-label="">
													...
													<div
														...
														<button class="btn btn-outline-info" name="submit" type="submit">Select Currency</button>
													</div>
												</div>
											</form>
										</div>
